...
- Segwit addresses (bech32, of the form `txc1...` for mainnet or `ttxc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
