# Fuzzing TexitCoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing TexitCoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the TexitCoin Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make TexitCoin Core more robust.
...
with certain assembly code from TexitCoin Core's code. See [developer notes on sanitizers](/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing TexitCoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing TexitCoin Core using [`afl-fuzz`](https://github.com/google/afl):
