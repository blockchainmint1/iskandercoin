TexitCoin Core version 0.16.3 is now available from:

  <https://download.texitcoin.org/texitcoin-0.16.3/>
...
TexitCoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
