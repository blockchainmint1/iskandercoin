Contributing to Iskander Core
============================

The Iskander Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Iskander Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/iskander-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to iskander-qt
...
The following applies to code changes to the Iskander Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Iskander
Network Protocol consensus changes.

Whether a pull request is merged into Iskander Core rests with the project merge
...
Patches that change Iskander consensus rules are considerably more involved than
...
Where a patch set proposes to change the Iskander consensus, it must have been
...
The project leader is the release manager for each Iskander Core release.
