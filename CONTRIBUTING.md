Contributing to TexitCoin Core
============================

The TexitCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the TexitCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/texitcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to texitcoin-qt
...
The following applies to code changes to the TexitCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall TexitCoin
Network Protocol consensus changes.

Whether a pull request is merged into TexitCoin Core rests with the project merge
...
Patches that change TexitCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the TexitCoin consensus, it must have been
...
The project leader is the release manager for each TexitCoin Core release.
