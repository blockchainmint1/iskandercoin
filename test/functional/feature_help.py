...
"""Verify that starting texitcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start texitcoin with -h for help text")
        ...
        self.log.info("Start texitcoin with -version for version information")
        ...
        self.log.info("Start texitcoind with -fakearg to make sure it does not start")
