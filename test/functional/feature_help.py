...
"""Verify that starting iskander with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start iskander with -h for help text")
        ...
        self.log.info("Start iskander with -version for version information")
        ...
        self.log.info("Start iskanderd with -fakearg to make sure it does not start")
