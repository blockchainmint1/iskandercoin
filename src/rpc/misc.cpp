...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The texitcoin address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    ...
    throw std::runtime_error(
        RPCHelpMan{"getaddressdeltas",
            ...
            RPCResult{
                RPCResult::Type::ARR, "", "A list of deltas for the given addresses",
                {
                    {RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::NUM, "satoshis", "The difference in satoshis"},
                            {RPCResult::Type::STR_HEX, "txid", "The related transaction ID"},
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"getaddressbalance",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "The balance information for the given addresses",
                    {
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"getaddressutxos",
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "A list of unspent transaction outputs for the given addresses",
                    {
                        {RPCResult::Type::OBJ, "", "",
                            {
                                {RPCResult::Type::STR, "address", "The address (base58check encoded)"},
                                {RPCResult::Type::STR_HEX, "txid", "The output transaction ID"},
                                {RPCResult::Type::NUM, "height", "The block height"},
                                {RPCResult::Type::NUM, "outputIndex", "The output index"},
                                {RPCResult::Type::STR_HEX, "script", "The script (hex encoded)"},
                                {RPCResult::Type::NUM, "satoshis", "The number of satoshis in the output"},
                            }
                        },
                    }
                },
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"getaddressmempool",
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "A list of mempool deltas for the given addresses",
                    {
                        {RPCResult::Type::OBJ, "", "",
                            {
                                ...
                                {RPCResult::Type::NUM, "index", "The related input or output index"},
                                {RPCResult::Type::NUM, "satoshis", "The difference in satoshis"},
                                {RPCResult::Type::NUM, "timestamp", "The time the transaction entered the mempool (in seconds)"},
                                {RPCResult::Type::STR_HEX, "prevtxid", "The previous transaction ID (if spending)"},
    ...
    if (request.fHelp || request.params.size() < 2)
        throw std::runtime_error(
            RPCHelpMan{"getblockhashes",
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "A list of block hashes or hashes with logical timestamps",
                    {
    ...
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            RPCHelpMan{"getspentinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "Details of the spending transaction",
                    {
                        {RPCResult::Type::STR_HEX, "txid", "The transaction ID where the output is spent"},
                        {RPCResult::Type::NUM, "index", "The input index in the spending transaction"},
                    }
                },
                RPCExamples{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"getaddresstxids",
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "A list of transaction IDs associated with the given addresses",
                    {
...
static RPCHelpMan verifymessage()
{
    return RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The texitcoin address to use for the signature."},
...
static RPCHelpMan echo(const std::string& name)
{
    return RPCHelpMan{name,
                ...
                "texitcoin-cli and the GUI. There is no server-side difference.",
                {
