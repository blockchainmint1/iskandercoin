    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            RPCHelpMan{"omni_decodetransaction",
               ...
               RPCResult{
                    RPCResult::Type::OBJ, "", /* optional */ false, "An object containing details about the decoded Omni transaction.",
                    {
                        {RPCResult::Type::STR, "txid", "The hex-encoded hash of the transaction."},
                        {RPCResult::Type::STR, "fee", "The transaction fee in litecoins."},
                        ...
                        {RPCResult::Type::ELISION, "other_properties", "Other transaction type-specific properties."}
                    }
                },
               RPCExamples{
