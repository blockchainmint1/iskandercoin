...
VIAddVersionKey ProductName "OmniLite"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\omnilite-qt.exe
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\omnilite-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\OmniLite.lnk"
