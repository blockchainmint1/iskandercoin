...
public:
    struct Entry {
        ...
        SERIALIZE_METHODS(Entry, obj) { 
            READWRITE(obj.issuer, obj.prop_type, obj.prev_prop_id, obj.category, obj.subcategory, obj.name, 
            obj.url, obj.data, obj.num_tokens, obj.property_desired, obj.deadline, obj.early_bird,
            obj.percentage, obj.close_early, obj.max_tokens, obj.missedTokens, obj.timeclosed, obj.txid_close,
            obj.txid, obj.creation_block, obj.update_block, obj.fixed, obj.manual, obj.unique,
            obj.historicalData, obj.historicalIssuers); 
        }
